...
from settings import cytec_stand_ip_address,dut_port,all_stands,advertisements,interactive_mode
...
init(autoreset=True)
print(Back.YELLOW + '[7]ADVERTISEMENT TEST                                                                     ')
...
#! FIND STAND MODEL NAME
    ...
    #!Advertisement TEST
    for current_advertisement in advertisements:
        print("------------------------------------------------------------------------------------------")
        print(Style.BRIGHT + f'TESTING: {current_advertisement}')
        print("------------------------------------------------------------------------------------------")
        #? LOGIN INTO DUT
        print('[SECURE SHELL]')
        print("Logging into DUT..")
        ...
        print(f"Executing command '/interface ethernet set {dut_port} auto-negotiation=yes advertise={current_advertisement}'")
        ssh.exec_command(f'/interface ethernet set {dut_port} auto-negotiation=yes advertise={current_advertisement}')
        time.sleep(6.0)
        print(f"DONE")
        ssh.close()
        
        #! Start PING test from STAND
        #? LOGIN INTO STAND
        print('[SECURE SHELL]')
        print("Logging into DUT..")
...
results_7 = return_results()
#?SAVE IN JSON
with open("results_7.json", "w") as f:
    json.dump(results_7, f)
